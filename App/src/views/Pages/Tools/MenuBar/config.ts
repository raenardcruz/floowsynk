...
export const menu_bar_style: ComponentStyle[] = [
    ...
    // End Styles
    { name: 'height', label: 'Height', group: Groups.DIMENSIONS, tab: Tabs.ENDITEM, control: DataTypes.TEXT, value: '44px', description: 'Sets the height of the element.' },
    { name: 'width', label: 'Width', group: Groups.DIMENSIONS, tab: Tabs.ENDITEM, control: DataTypes.TEXT, value: '44px', description: 'Sets the width of the element.' },
    { name: 'border-radius', label: 'Border Radius', group: Groups.DIMENSIONS, tab: Tabs.ENDITEM, control: DataTypes.TEXT, value: '0', description: 'Sets how round the logo.' },
    { name: 'border-width', label: 'Border Thickness', group: Groups.DIMENSIONS, tab: Tabs.ENDITEM, control: DataTypes.TEXT, value: '0', description: 'Sets the thickness of the border.', dependency: { name: 'border-radius', regexExp: /^-?\d+(\.\d+)?(px|cm|mm|in|pt|pc|%|em|ex|ch|rem|vw|vh|vmin|vmax|fr)$/ } },
    { name: 'border-style', label: 'Border Style', group: Groups.DIMENSIONS, tab: Tabs.ENDITEM, control: DataTypes.SELECT, options: ['solid', 'dashed', 'dotted'], value: 'solid', description: 'Sets the style of the border.', dependency: { name: 'border-radius', regexExp: /^-?\d+(\.\d+)?(px|cm|mm|in|pt|pc|%|em|ex|ch|rem|vw|vh|vmin|vmax|fr)$/ } },
    { name: 'border-color', label: 'Border Color', group: Groups.DIMENSIONS, tab: Tabs.ENDITEM, control: DataTypes.COLOR, value: 'black', description: 'Sets the color of the border.', dependency: { name: 'border-radius', regexExp: /^-?\d+(\.\d+)?(px|cm|mm|in|pt|pc|%|em|ex|ch|rem|vw|vh|vmin|vmax|fr)$/ } },
    { name: 'font-size', label: 'Font Size', group: Groups.TYPOGRAPHY, tab: Tabs.ENDITEM, control: DataTypes.TEXT, value: '14px', description: 'Sets the size of the font.' },
    { name: 'font-weight', label: 'Font Weight', group: Groups.TYPOGRAPHY, tab: Tabs.ENDITEM, control: DataTypes.SELECT, options: ['normal', 'bold', 'bolder', 'lighter'], value: 'normal', description: 'Sets the weight of the font.' },
    { name: 'color', label: 'Font Color', group: Groups.TYPOGRAPHY, tab: Tabs.ENDITEM, control: DataTypes.COLOR, value: 'black', description: 'Sets the color of the font.' },
    { name: 'text-transform', label: 'Text Transform', group: Groups.TYPOGRAPHY, tab: Tabs.ENDITEM, control: DataTypes.SELECT, options: ['none', 'capitalize', 'uppercase', 'lowercase'], value: 'none', description: 'Controls the capitalization of text.' },
    { name: 'letter-spacing', label: 'Letter Spacing', group: Groups.TYPOGRAPHY, tab: Tabs.ENDITEM, control: DataTypes.TEXT, value: 'normal', description: 'Sets the spacing between letters.' },
    { name: 'text-decoration', label: 'Text Decoration', group: Groups.TYPOGRAPHY, tab: Tabs.ENDITEM, control: DataTypes.SELECT, options: ['none', 'underline', 'overline', 'line-through'], value: 'none', description: 'Sets the decoration of the text.' },
    { name: 'text-align', label: 'Text Align', group: Groups.TYPOGRAPHY, tab: Tabs.ENDITEM, control: DataTypes.SELECT, options: ['left', 'right', 'center', 'justify'], value: 'left', description: 'Sets the alignment of the text.' },
    { name: 'margin', label: 'Margin', group: Groups.SPACING, tab: Tabs.ENDITEM, control: DataTypes.TEXT, value: '', placeholder: 'e.g. 8px 16px', description: 'Sets the space outside the element.' },
    { name: 'padding', label: 'Padding', group: Groups.SPACING, tab: Tabs.ENDITEM, control: DataTypes.TEXT, value: '8px', placeholder: 'e.g. 8px 16px', description: 'Sets the space inside the element, between the content and the border.' },
]