export const heading_styles = [
  ...
  // Background
  { name: 'background', label: 'Background', group: 'Background', section: 3, control: 'color', value: '#C2D7EB', placeholder: 'e.g. #ffffff', description: 'Sets the background color of the element.' },
