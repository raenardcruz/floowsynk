export const section_styles = [
  ...
  { name: 'font-size', label: 'Font Size', group: 'Font', section: 2, control: 'text', value: '', placeholder: 'e.g. 16px, 1.2em', description: 'Sets the size of the text.' },
  ...
  // Shadow
  { name: 'text-shadow', label: 'Text Shadow', group: 'Shadow', section: 2, control: 'text', value: '', placeholder: 'e.g. 1px 1px 2px #000', description: 'Adds a shadow effect to the text.' },

  // Section 3: Background and Borders
  // Background
  { name: 'background', label: 'Background', group: 'Background', section: 3, control: 'color', value: '', placeholder: 'e.g. #ffffff', description: 'Sets the background color of the element.' },
  { name: 'background-size', label: 'Background Size', group: 'Background', section: 3, control: 'select', options: ['auto', 'cover', 'contain'], value: 'auto', description: 'Specifies the size of the background image.' },
  { name: 'background-repeat', label: 'Background Repeat', group: 'Background', section: 3, control: 'select', options: ['repeat', 'no-repeat', 'repeat-x', 'repeat-y'], value: 'repeat', description: 'Controls if/how the background image repeats.' },
  { name: 'background-position', label: 'Background Position', group: 'Background', section: 3, control: 'text', value: '', placeholder: 'e.g. center, top left', description: 'Sets the starting position of the background image.' },
  { name: 'background-attachment', label: 'Background Attachment', group: 'Background', section: 3, control: 'select', options: ['scroll', 'fixed', 'local'], value: 'scroll', description: 'Sets whether the background scrolls with the page.' },
  // Borders
  { name: 'border-width', label: 'Border Width', group: 'Borders', section: 3, control: 'text', value: '', placeholder: 'e.g. 1px', description: 'Sets the width of the border.' },
  { name: 'border-style', label: 'Border Style', group: 'Borders', section: 3, control: 'select', options: ['none', 'solid', 'dotted', 'dashed', 'double', 'groove', 'ridge', 'inset', 'outset'], value: 'none', description: 'Sets the style of the border.' },
  { name: 'border-color', label: 'Border Color', group: 'Borders', section: 3, control: 'color', value: '', placeholder: 'e.g. #cccccc', description: 'Sets the color of the border.' },
  { name: 'border-radius', label: 'Border Radius', group: 'Borders', section: 3, control: 'text', value: '', placeholder: 'e.g. 8px', description: 'Rounds the corners of the border.' },
  // Shadow
  { name: 'box-shadow', label: 'Box Shadow', group: 'Shadow', section: 3, control: 'text', value: '', placeholder: 'e.g. 0 2px 8px #00000022', description: 'Adds a shadow effect to the element.' },

  // Section 4: Effects and Transforms
  // Opacity
  { name: 'opacity', label: 'Opacity', group: 'Opacity', section: 4, control: 'text', value: '', placeholder: 'e.g. 0.5', description: 'Sets the transparency level of the element.' },
  // Transition
  { name: 'transition-property', label: 'Transition Property', group: 'Transition', section: 4, control: 'text', value: '', placeholder: 'e.g. all, opacity', description: 'Specifies the CSS property to which the transition is applied.' },
  { name: 'transition-duration', label: 'Transition Duration', group: 'Transition', section: 4, control: 'text', value: '', placeholder: 'e.g. 0.3s', description: 'Sets how long the transition takes.' },
  { name: 'transition-timing-function', label: 'Transition Timing Function', group: 'Transition', section: 4, control: 'select', options: ['ease', 'linear', 'ease-in', 'ease-out', 'ease-in-out', 'step-start', 'step-end'], value: 'ease', description: 'Sets the speed curve of the transition.' },
  { name: 'transition-delay', label: 'Transition Delay', group: 'Transition', section: 4, control: 'text', value: '', placeholder: 'e.g. 0.1s', description: 'Sets the delay before the transition starts.' },
  // Transforms
  { name: 'transform', label: 'Rotate', group: 'Transforms', section: 4, control: 'text', value: '', placeholder: 'e.g. rotate(45deg)', description: 'Rotates the element.' },
  { name: 'transform', label: 'Scale', group: 'Transforms', section: 4, control: 'text', value: '', placeholder: 'e.g. scale(1.2)', description: 'Scales (resizes) the element.' },
  { name: 'transform', label: 'Translate', group: 'Transforms', section: 4, control: 'text', value: '', placeholder: 'e.g. translateX(10px)', description: 'Moves (translates) the element.' },
  { name: 'transform', label: 'Skew', group: 'Transforms', section: 4, control: 'text', value: '', placeholder: 'e.g. skew(10deg)', description: 'Skews (distorts) the element.' },
  { name: 'transform-origin', label: 'Transform Origin', group: 'Transforms', section: 4, control: 'text', value: '', placeholder: 'e.g. center, top left', description: 'Sets the point around which a transformation is applied.' },
  // Filters
  { name: 'filter-blur', label: 'Blur', group: 'Filters', section: 4, control: 'text', value: '', placeholder: 'e.g. 4px', description: 'Applies a blur effect to the element.' },
  { name: 'filter-brightness', label: 'Brightness', group: 'Filters', section: 4, control: 'text', value: '', placeholder: 'e.g. 120%', description: 'Adjusts the brightness of the element.' },
  { name: 'filter-contrast', label: 'Contrast', group: 'Filters', section: 4, control: 'text', value: '', placeholder: 'e.g. 150%', description: 'Adjusts the contrast of the element.' },
  { name: 'filter-grayscale', label: 'Grayscale', group: 'Filters', section: 4, control: 'text', value: '', placeholder: 'e.g. 80%', description: 'Converts the element to grayscale.' },
  { name: 'filter-invert', label: 'Invert', group: 'Filters', section: 4, control: 'text', value: '', placeholder: 'e.g. 100%', description: 'Inverts the colors of the element.' },
  { name: 'filter-saturate', label: 'Saturate', group: 'Filters', section: 4, control: 'text', value: '', placeholder: 'e.g. 200%', description: 'Adjusts the color saturation of the element.' },
  { name: 'filter-sepia', label: 'Sepia', group: 'Filters', section: 4, control: 'text', value: '', placeholder: 'e.g. 60%', description: 'Applies a sepia tone to the element.' },
]