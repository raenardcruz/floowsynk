...
export const COMPONENTS = [
  ...
  // Basic Elements - Buttons and Links
  {
    name: 'button',
  ...
  // Advanced Elements - Dynamic Content
  {
    name: 'image-gallery',
